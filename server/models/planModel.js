...
const planSchema = new mongoose.Schema(
  {
    ...
    startTime: { type: String, required: false }, //activity, lodging (Giờ nhận phòng),     flights(Giờ khởi hành)    ,car(ngày trả)            concert&theater(Tzan bắt đầu)
    endTime: { type: String, required: false }, //activity,   lodging (Giờ trả phòng),      flights(Giờ tới)          ,car(thời gian trả)       concert&theater(Tzan kết thúc)
