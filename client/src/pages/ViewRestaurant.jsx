        ...
        <div className="max-w-full bg-white flex flex-col rounded overflow-hidden shadow-lg">
          ...
          <div className="mt-2 flex sm:flex-row mx-6 sm:justify-between flex-wrap ">
            ...
            <div className="flex flex-row place-items-center p-2">
              <div className="flex flex-col ml-2">
                ...
                <p className="text-xs text-gray-500">Ẩm thực: {describe}</p>
                <p className="text-xs text-gray-500">Trang phục: {form}</p>
              </div>
            </div>
          </div>
          <div className="mt-4 bg-gray-100 flex flex-row flex-wrap md:flex-nowrap justify-between">
            <div className="flex mx-6 py-4 flex-row flex-wrap items-center">
              <QRCode
                id="qrCodeEl"
                value={`http://localhost:3000/trip/${id}/restaurant/${planId}/view`}
                size={100}
                fgColor={"#000000"}
                bgColor={"#FFFFFF"}
                level={"M"}
